...
public class SearchTrain extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            // pw.println("testing");
            trlistcontent = "<table id='trainlist' border='2' cellspacing='3' cellpadding='8' bordercolor='Blue' align='center' style='align-items: center;'><tr><th>Train Name</th><th>Train Number</th><th>Price</th><th>Date of Travel</th><th>Source</th><th>Destination</th><th>Available Seats</th><th>Duration</th><th>Book Now</th></tr> ";
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    trlistcontent += "<tr>";
                    ...
                    trlistcontent += "<td><button class='open-button' onclick='booknow(\""+trlist[i][1]+"\", document.getElementById(\"tnoin\").innerHTML, document.getElementById(\"pricein\").innerHTML, document.getElementById(\"dotin\").innerHTML, document.getElementById(\"srcin\").innerHTML, document.getElementById(\"desin\").innerHTML, document.getElementById(\"seatsin\").innerHTML, document.getElementById(\"durin\").innerHTML);'>Book Ticket</button></td>";
                    trlistcontent += "</tr>";
                }
            }
            trlistcontent += "</table>";
